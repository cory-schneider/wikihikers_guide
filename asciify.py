...
ASCII_TWO = list('`^",:;Il!i~+_-?][}{1)(|\\/tfjrxnuvczXYUJCLQ0OZmwqpdbkhao*#MW&8%B@$')
ASCII_TWO = ASCII_TWO[::-1]

ASCII_CHARS = ['.',',',':',';','+','*','?','%','S','#','@']
ASCII_CHARS = ASCII_CHARS[::-1]

def external_asciify(url):

    print(f"Image location: {url}")

    urllib.request.urlretrieve("https://" + url, "asciify.jpg")
    path = "asciify.jpg"
